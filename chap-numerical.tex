...
%
%Monte Carlo methods are among the most important estimation techniques in
%applied mathematics and physics. The basic idea is to esimate a distribution
...
% TODO: comment u < 0 (why? constrained by 0 < q_l < 1)
% TODO: special cases for short-range, complete, diluted
...
We now derive the transition probabilities for the replica exhange moves
...
% TODO: corrections to scaling
Scaling functions $\scalefunc{X}$, $\scalefunc{g}$ predicted to be universal (up
